...
This repo is a fork of https://github.com/jakejarvis/s3-sync-action.
It adds the possibility of invalidating cache of a specified CloudFront Distribution after updating the respective S3 Bucket. 

> Only root folder option available for now.
...
| `AWS_DISTRIBUTION_ID` | Your CloudFront Distribution ID for cache to be invalidated. | `secret env` | Yes | N/A |
